...
<body>
    ...
    @section('index-content')
        <header class="header">
            ...
            <button class="button button-golden header__button">TAKE A TOUR</button>
        ...
        <section class="about-data">
            <div class="about-data__discover">
                ...
                <button class="button button-golden about-data__discover__button">BOOK NOW</button>
            </div>
        ...
        <section class="home-video">
            <div class="home-video__container">
                <div class="home-video__text">
                    ...
                    <button class="button button-golden home-video__button--desktop">BOOK NOW</button>
                </div>
